...
module.exports = (deployer, network, accounts) => {
    ...
    //         {from: deployAddress});
    // });
    deployer.deploy(Rewards,  {from: deployAddress, gas:7000000});
    deployer.deploy(Oracles,  {from: deployAddress, gas:7000000});
    deployer.deploy(OraclesController,  {from: deployAddress, gas:7000000});
    deployer.deploy(Admin,  {from: deployAddress, gas:7000000});
    deployer.deploy(Events,  {from: deployAddress, gas:7000000});
    deployer.deploy(OracleVerifier,  {from: deployAddress, gas:7000000});
    deployer.deploy(Wagers,  {from: deployAddress, gas:7000000});
    deployer.deploy(WagersController,  {from: deployAddress, gas:7000000});
    deployer.deploy(Mevu,  {from: deployAddress, gas:7000000, value:100000000000000000});
